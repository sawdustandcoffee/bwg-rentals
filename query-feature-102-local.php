<?php
// Query Feature #102 from the local database (including WAL changes)
$db = new SQLite3(__DIR__ . '/features.db');

// Get feature #102
$stmt = $db->prepare('SELECT id, priority, category, name, description, steps, passes, in_progress, dependencies FROM features WHERE id = 102');
$result = $stmt->execute();

if ($row = $result->fetchArray(SQLITE3_ASSOC)) {
    echo "=== FEATURE #102 ===" . PHP_EOL;
    ...
    echo "Feature #102 not found" . PHP_EOL;
